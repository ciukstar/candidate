...
import Foundation
  ...
  , AppMessage
    ...
    , MsgTags, MsgUseCaseDiagram, MsgEntityRelationshipDiagram
    , MsgDoc1, MsgDoc11, MsgDoc111
...
import Settings.StaticFiles (img_Candidate_ERD_svg, img_Candidate_UCD_svg)
